        ...
        <div className="container mx-auto px-4">
          ...
          {canViewOwnerConsole && (
            <div className="mb-6 flex justify-end gap-3">
              <Link
                to="/admin/system"
                className="inline-flex items-center rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-slate-200 hover:bg-white/10 transition-all"
              >
                View System Status
              </Link>
              <Link
